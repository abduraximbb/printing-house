...
const admin_strategy_1 = require("../common/strategy/admin.strategy");
let WorkersModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [sequelize_1.SequelizeModule.forFeature([worker_model_1.Worker]), jwt_1.JwtModule.register({})],
            controllers: [workers_controller_1.WorkersController],
            providers: [workers_service_1.WorkersService, admin_strategy_1.AdminStrategy],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var WorkersModule = _classThis = class {
    };
