...
let ProductsController = (() => {
    ...
    (() => {
        ...
        _create_decorators = [(0, swagger_1.ApiOperation)({ summary: "Add new proudct" }), (0, swagger_1.ApiResponse)({
                status: 201,
                description: "Added new proudct",
                type: product_model_1.Products,
            }), (0, common_1.UseGuards)(admin_guard_1.AdminGuard), (0, common_1.Post)()];
        _findAll_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get all products" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "All products",
                type: [product_model_1.Products],
            }), (0, common_1.Get)()];
        _findOne_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get product by id" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Found product by id",
                type: product_model_1.Products,
            }), (0, common_1.Get)(":id")];
        _update_decorators = [(0, swagger_1.ApiOperation)({ summary: "Update product by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Updated product",
                type: product_model_1.Products,
            }), (0, common_1.UseGuards)(admin_guard_1.AdminGuard), (0, common_1.Patch)(":id")];
        _remove_decorators = [(0, swagger_1.ApiOperation)({ summary: "Delete product by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
