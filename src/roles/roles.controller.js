...
let RolesController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)("Roles of workers"), (0, common_1.Controller)("roles")];
    ...
    (() => {
        ...
        _create_decorators = [(0, swagger_1.ApiOperation)({ summary: "Add new role" }), (0, swagger_1.ApiResponse)({
                status: 201,
                description: "Added new role",
                type: role_model_1.Role,
            }), (0, common_1.UseGuards)(admin_guard_1.AdminGuard), (0, common_1.Post)()];
        _findAll_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get all roles" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "All roles",
                type: [role_model_1.Role],
            }), (0, common_1.Get)()];
        _findOne_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get role by id" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Found role by id",
                type: role_model_1.Role,
            }), (0, common_1.Get)(":id")];
        _update_decorators = [(0, swagger_1.ApiOperation)({ summary: "Update role by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Updated role",
                type: role_model_1.Role,
            }), (0, common_1.UseGuards)(admin_guard_1.AdminGuard), (0, common_1.Patch)(":id")];
        _remove_decorators = [(0, swagger_1.ApiOperation)({ summary: "Delete role by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
