...
let CreateClientDto = (() => {
    ...
    return _a = class CreateClientDto {
        ...
        (() => {
            ...
            _first_name_decorators = [(0, swagger_1.ApiProperty)({ example: "John", description: "Enter client's first name" }), (0, class_validator_1.IsString)()];
            _last_name_decorators = [(0, swagger_1.ApiProperty)({ example: "Doe", description: "Enter client's last name" }), (0, class_validator_1.IsString)()];
            ...
            _password_decorators = [(0, swagger_1.ApiProperty)({ example: "password", description: "Enter client's password" }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
