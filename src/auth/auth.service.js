...
let AuthService = (() => {
    ...
    var AuthService = _classThis = class {
        constructor(jwtService, adminModel) {
        ...
        updateRefreshToken(adminId, refresh_token) {
            return __awaiter(this, void 0, void 0, function* () {
                const hashed_refresh_token = yield bcrypt.hash(refresh_token, 7);
                yield this.adminModel.update({ hashed_refresh_token }, { where: { id: adminId } });
            });
        }
        addAdmin(createAdminDto, res) {
            return __awaiter(this, void 0, void 0, function* () {
                const candidate = yield this.adminModel.findOne({
                ...
                const hashed_password = yield bcrypt.hash(createAdminDto.password, 7);
                ...
                yield this.updateRefreshToken(newAdmin.id, tokens.refresh_token);
        ...
        refreshtoken(refreshToken, res, id) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const admin = yield this.adminModel.findByPk(payload.id);
                    if (!admin) {
                    ...
                    const tokens = yield this.generateTokens(admin);
                    yield this.updateRefreshToken(admin.id, tokens.refresh_token);
                    res.cookie("refresh_token", tokens.refresh_token, {
                        httpOnly: true,
                        maxAge: +process.env.COOKIE_TIME,
                    });
        ...
        signout(refreshToken, res, id) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    yield this.adminModel.update({ hashed_refresh_token: "" }, { where: { id: payload.id } });
