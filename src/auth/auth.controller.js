...
let AuthController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)("Auth for admin"), (0, common_1.Controller)("auth")];
    ...
    (() => {
        ...
        _signUp_decorators = [(0, swagger_1.ApiOperation)({ summary: "Yangi adminni ro'yxatdan o'tkizish" }), (0, swagger_1.ApiResponse)({
                status: 201,
                description: "Ro'yxatdan o'tgan admin",
                type: String,
            }), (0, common_1.UseGuards)(creator_guard_1.CreatorGuard), (0, common_1.Post)("add")];
