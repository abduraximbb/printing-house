...
let PaymentStatusService = (() => {
    ...
    let _classThis;
    var PaymentStatusService = _classThis = class {
        ...
        update(id, updatePaymentStatusDto) {
            return __awaiter(this, void 0, void 0, function* () {
                const updated_payment_status = yield this.paymentStatusModel.update(updatePaymentStatusDto, { where: { id }, returning: true });
    ...
    __setFunctionName(_classThis, "PaymentStatusService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PaymentStatusService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaymentStatusService = _classThis;
})();
