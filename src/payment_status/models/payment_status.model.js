...
let Payment_status = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "payment_status", timestamps: false })];
    ...
    var Payment_status = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.status = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _status_initializers, void 0));
            this.payments = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _payments_initializers, void 0));
            __runInitializers(this, _payments_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Payment_status");
    (() => {
        var _a;
        ...
        Payment_status = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Payment_status = _classThis;
})();
