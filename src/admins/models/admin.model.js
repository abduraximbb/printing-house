...
let Admin = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "admins", timestamps: false })];
    ...
    var Admin = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.hashed_password = (__runInitializers(this, _username_extraInitializers), __runInitializers(this, _hashed_password_initializers, void 0));
            this.description = (__runInitializers(this, _hashed_password_extraInitializers), __runInitializers(this, _description_initializers, void 0));
            this.hashed_refresh_token = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _hashed_refresh_token_initializers, void 0));
    ...
    (() => {
        ...
        _is_creator_decorators = [(0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.BOOLEAN,
                defaultValue: false,
            })];
