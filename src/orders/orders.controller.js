...
let OrdersController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)("Orders"), (0, common_1.Controller)("orders")];
    ...
    (() => {
        ...
        _create_decorators = [(0, swagger_1.ApiOperation)({ summary: "Add new order" }), (0, swagger_1.ApiResponse)({
                status: 201,
                description: "Added new order",
                type: order_model_1.Order,
            }), (0, common_1.Post)()];
        _findAll_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get all orders" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "All orders",
                type: [order_model_1.Order],
            }), (0, common_1.Get)()];
        _findOne_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get order by id" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Found order by id",
                type: order_model_1.Order,
            }), (0, common_1.Get)(":id")];
        _update_decorators = [(0, swagger_1.ApiOperation)({ summary: "Update order by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Updated order",
                type: order_model_1.Order,
            }), (0, common_1.Patch)(":id")];
        _remove_decorators = [(0, swagger_1.ApiOperation)({ summary: "Delete order by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
