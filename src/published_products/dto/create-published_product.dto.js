...
exports.CreatePublishedProductDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
let CreatePublishedProductDto = (() => {
    var _a;
    let _orderId_decorators;
    let _orderId_initializers = [];
    let _orderId_extraInitializers = [];
    return _a = class CreatePublishedProductDto {
            constructor() {
        ...
        (() => {
            ...
            _orderId_decorators = [(0, swagger_1.ApiProperty)({ example: 1, description: "Enter product ID" }), (0, class_validator_1.IsNumber)()];
...
exports.CreatePublishedProductDto = CreatePublishedProductDto;
