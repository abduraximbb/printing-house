...
let Payment_type = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "payment_type", timestamps: false })];
    ...
    var Payment_type = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.payments = (__runInitializers(this, _type_name_extraInitializers), __runInitializers(this, _payments_initializers, void 0));
            __runInitializers(this, _payments_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Payment_type");
    (() => {
        var _a;
        ...
        Payment_type = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Payment_type = _classThis;
})();
