...
const payment_type_model_1 = require("./models/payment_type.model");
let PaymentTypeController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)("Payment's type"), (0, common_1.Controller)("payment-type")];
    ...
    var PaymentTypeController = _classThis = class {
        constructor(paymentTypeService) {
            this.paymentTypeService = (__runInitializers(this, _instanceExtraInitializers), paymentTypeService);
        }
    ...
    __setFunctionName(_classThis, "PaymentTypeController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _create_decorators = [(0, swagger_1.ApiOperation)({ summary: "Add new payment type" }), (0, swagger_1.ApiResponse)({
                status: 201,
                description: "Added new payment type",
                type: payment_type_model_1.Payment_type,
            }), (0, common_1.Post)()];
        _findAll_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get all payment types" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "All payment types",
                type: [payment_type_model_1.Payment_type],
            }), (0, common_1.Get)()];
        _findOne_decorators = [(0, swagger_1.ApiOperation)({ summary: "Get payment type by id" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Found payment type by id",
                type: payment_type_model_1.Payment_type,
            }), (0, common_1.Get)(":id")];
        _update_decorators = [(0, swagger_1.ApiOperation)({ summary: "Update payment type by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: "Updated payment type",
                type: payment_type_model_1.Payment_type,
            }), (0, common_1.Patch)(":id")];
        _remove_decorators = [(0, swagger_1.ApiOperation)({ summary: "Delete payment type by ID" }), (0, swagger_1.ApiResponse)({
                status: 200,
        ...
        PaymentTypeController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaymentTypeController = _classThis;
})();
