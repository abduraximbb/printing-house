...
let CreatePaymentTypeDto = (() => {
    ...
    return _a = class CreatePaymentTypeDto {
        ...
        (() => {
            ...
            _type_name_decorators = [(0, swagger_1.ApiProperty)({ example: "Card", description: "Enter payment's type" }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
