...
let OrderStatus = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "order_status", timestamps: false })];
    ...
    var OrderStatus = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_classThis, "OrderStatus");
    (() => {
        var _a;
